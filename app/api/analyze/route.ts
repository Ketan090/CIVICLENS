...
export async function POST(req: NextRequest) {
  ...
  const prompt = `You are CivicLens — municipal civic intelligence. Analyze the image precisely. RequestId:${Date.now()}
...
Style: ALL text must be CLEAR, PRECISE, FORMAL tone. No slang, no emojis, no filler. Be concise and official.
